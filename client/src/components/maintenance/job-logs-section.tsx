              ...
              <DialogContent className="sm:max-w-[550px]">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    {/* Add all form fields from the original component */}
          ...
          isLoading ? (
            ...
            <div className="rounded-md border">
              <Table>
                ...
                <TableBody>
                  {jobLogs.map((job) => {
                    const storeName = stores.find((store) => store.id === job.storeId)?.name || "Unknown";
                    ...
                    return (
                      <TableRow key={job.id}>
                        ...
                        <TableCell className="hidden sm:table-cell">{storeName}</TableCell>
                      </TableRow>
                    );
                  })}
                </TableBody>
