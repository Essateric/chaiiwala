...
async function sendRealEmail(pdfBuffer, fileName, recipientEmail = 'essateric@gmail.com') {
  ...
  const mailOptions = {
    from: emailUser,
    to: recipientEmail,
    subject: `PDF Conversion Complete - ${fileName}`,
    text: `PDF "${fileName}" attached.\n\nGenerated by Astral Blu Apps.`,
    html: `<h2>PDF Conversion Complete</h2><p>PDF "<strong>${fileName}</strong>" is attached.</p><hr><p><em>Generated by <a href="https://www.astralblu.com">Astral Blu Apps</a></em></p>`,
    attachments: [
      {
        filename: fileName,
        content: pdfBuffer,
